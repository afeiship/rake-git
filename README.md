...
rake git:tag_create_with_msg[version]  # Create with msg tag from semver file(eg: package.json/.semver)
...
rake git:tag_list_local[version]       # List local tag from semver file(eg: package.json/.semver)
rake git:tag_list_remote[version]      # List remote tag from semver file(eg: package.json/.semver)
